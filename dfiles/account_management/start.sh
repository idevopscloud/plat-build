...
app_root="/idevops/app/account_management"
...
link_volumns()
{
    storage_path="/idevops/app/account_management/storage"
    mnt_path="/mnt/account_management"
    ...
    icon_path="/idevops/app/account_management/public/icons"
    mkdir -p /mnt/account_management/icons
    chown www-data:www-data /mnt/account_management/icons
    rm -rf $icon_path
